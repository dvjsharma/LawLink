...
const Footer=()=>{
    return(
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex justify-between">
            <div className="mb-6 md:mb-0">
              <a href="" className="flex items-center ">
                <p  className="self-center  text-2xl font-semibold text-white">WEBSITE NAME</p>
              </a>
            </div>
            
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 sm:gap-6">
              <div>
                <h2 className="mb-6 text-sm font-semibold uppercase text-white">Sections</h2>
          ...
          <div className="flex-nowrap sm:flex sm:flex-col sm:items-center sm:justify-center mb-3">
            <p className="text-sm text-gray-500 dark:text-gray-400 sm:text-center mb-5 ">© 2023 . All Rights Reserved. </p>
            <div className="mt-4  flex justify-end items-center space-x-5 sm:mt-0 sm:justify-center">
